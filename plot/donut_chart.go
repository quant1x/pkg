...
// DonutChart is a plot that draws sections of a circle based on percentages with an hole.
...
func (pc DonutChart) finalizeValues(values []Value) ([]Value, error) {
	...
	if len(finalValues) == 0 {
		return nil, fmt.Errorf("donut plot must contain at least (1) non-zero value")
	}
