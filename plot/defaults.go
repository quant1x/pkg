...
const (
	// DefaultChartHeight is the default plot height.
	DefaultChartHeight = 400
	// DefaultChartWidth is the default plot width.
	DefaultChartWidth = 1024
	// DefaultStrokeWidth is the default plot stroke width.
	DefaultStrokeWidth = 0.0
	// DefaultDotWidth is the default plot dot width.
	DefaultDotWidth = 0.0
	// DefaultSeriesLineWidth is the default line width.
	DefaultSeriesLineWidth = 1.0
	// DefaultAxisLineWidth is the line width of the axis lines.
	DefaultAxisLineWidth = 1.0
	//DefaultDPI is the default dots per inch for the plot.
	DefaultDPI = 92.0
	...
	// DefaultTitleTop is the default distance from the top of the plot to put the title.
	DefaultTitleTop = 10

	// DefaultBackgroundStrokeWidth is the default stroke on the plot background.
	DefaultBackgroundStrokeWidth = 0.0
	// DefaultCanvasStrokeWidth is the default stroke on the plot canvas.
	...
	// DefaultBarWidth is the default pixel width of bars in a bar plot.
	DefaultBarWidth = 50
)
