...
func TestGenerate(t *testing.T) {
	Generate("https://github.com/quant1x/gox/qrterminal", L, os.Stdout)
}
...
func TestGenerateWithConfig(t *testing.T) {
	...
	GenerateWithConfig("https://github.com/quant1x/gox/qrterminal", config)
}

func TestGenerateHalfBlock(t *testing.T) {
	GenerateHalfBlock("https://github.com/quant1x/gox/qrterminal", L, os.Stdout)
}
